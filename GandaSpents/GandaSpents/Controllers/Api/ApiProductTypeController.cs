...
namespace GandaSpents.Controllers.Api
{
    ...
    [ApiController]
    public class ApiProductTypeController : ApiController<ProductType>
    {
        private readonly IProductTypeRepository _productTypeRepository;

        public ApiProductTypeController(IProductTypeRepository productTypeRepository, LinkGenerator linkGenerator, IMapper mapper) : base (productTypeRepository,linkGenerator,mapper)
        {
