...
namespace GandaSpents.Controllers.Api
{
    ...
    [ApiController]
    public class ApiProductController : ApiController<Product>
    {
        private readonly IProductRepository _productRepository;

        public ApiProductController(IProductRepository productRepository, LinkGenerator linkGenerator, IMapper mapper): base(productRepository,linkGenerator,mapper)
        {
