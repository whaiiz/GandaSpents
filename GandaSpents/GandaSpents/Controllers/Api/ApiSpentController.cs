...
namespace GandaSpents.Controllers.Api
{
    ...
    [ApiController]
    public class ApiSpentController : ApiController<Spent>
    {
        private readonly ISpentRepository _spentRepository;
        
        public ApiSpentController(ISpentRepository spentRepository, LinkGenerator linkGenerator, IMapper mapper): base(spentRepository,linkGenerator,mapper)
        {
